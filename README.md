...
This screen clip shows the SelectionLayerFilter extension in use. Each time the current selection changes, the list of visible layers updates to display only layers referenced by the currently-selected entities.
